...
(function () {
    ...
    R.getRGB = cacher(function (colour) {
        ...
        if (rgb) {
            ...
            rgb.toString = function () { return this.hex; };
    ...
    var pathDimensions = cacher(function (path) {
        ...
        parseDots = cacher(function (gradient) {
            ...
            for (var i = 0, ii = gradient[length]; i < ii; i++) {
                ...
                dot.color.toString = function () { return "rgba(" + this.r + "," +
                    this.g + "," + this.b + "," + ((this.opacity === 0) ? 0 : this.opacity || 1) +
                    ")"};
                dots[push](dot);
            }
    ...
    if (R.svg) {
        ...
        var addGradientFill = function (o, gradient, SVG) {
            ...
            for (var i = 0, ii = dots[length]; i < ii; i++) {
                ...
                $(stop, {
                    ...
                    "stop-color": dots[i].color.toString() || "#fff"
                });
                el[appendChild](stop);
            }
            $(o, {
        ...
        var addGradientStroke = function (o, gradient, SVG) {
            var type = "linear",
                fx = .5, fy = .5,
                s = o.style;
            gradient = Str(gradient)[rp](radial_gradient, function (all, _fx, _fy) {
...
/* *********************** */
                            if (clr.error) {
                                addGradientStroke(node, value, o.paper)
                            }
                            else {
                                node[setAttribute](att, clr.toString());
                            }
